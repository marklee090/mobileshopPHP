...
$html_cataloglist = showdm_admin($catalog_list, $id);
?>
    ...
    <form class="addPro" action="index.php?pg=update_product" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="giasp" value="<?= ($giasp > 0) ? $giasp : 0 ?>" id="giasp" class="form-control" placeholder="Nhập giá gốc">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <button type="submit" name="addproduct" class="btn btn-dark">Thêm sản phẩm</button>
        </div>
    </form>
</div>
</body>
